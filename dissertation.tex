...
\begin{minipage}{0.9\textwidth} \centering
	...
	\captionof{figure}{The router buffers traffic en-route to the \texttt{10.0.2.0/24} or \texttt{10.0.3.0/24} subnets, as specified by the packet filter.}
	\label{fig:ip_route}
\end{minipage}
\end{center}
